...
// console.log(objectTest['nameZeigen']())
...
// console.log(myObjectArr.findIndex(obj => obj.name === "Justus"));
// console.log(myObjectArr.filter(obj => obj.name === "Justus"))
